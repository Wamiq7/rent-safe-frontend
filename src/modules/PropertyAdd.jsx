...
export default function PropertyAdd() {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log(
      "Successfully uploaded images to IPFS with hashes:",
      ipfsHashes
    );
  ...
  return (
    <div className="flex justify-center my-10 items-center h-[calc(100vh-81.63px])] pt-4">
              ...
              <label className="block text-gray-700 text-sm font-bold mb-2">
                ...
                <input
                  ...
                  className={`shadow appearance-none border ${
                    errors[field] ? "border-red-500" : "rounded"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2">
              ...
              <div
                ...
                className="box-decoration w-full py-6 rounded-lg border border-gray-300 hover:bg-gray-100 flex items-center justify-center"
              >
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2">
              ...
              <div
                onClick={handleClick}
                style={{ cursor: "pointer" }}
                className="box-decoration w-full py-6"
              >
                {images.length > 0 ? (
                  images.map((image, index) => (
                    <img
                      ...
                      className="aspect-video md:w-full h-40 object-cover rounded-lg mb-2"
                    />
                  ))
                ) : (
