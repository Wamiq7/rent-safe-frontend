...
function AgreementDetails({ agreementData }) {
  ...
  return !isObjectEmpty(agreementData) ? (
    <div className="flex flex-col max-w-screen-sm md:max-w-none lg:max-w-none items-center justify-center mx-3">
      ...
      >
        {/* ------------------Agreement Banner */}
        <div className="flex justify-between w-full mt-6 md:items-between place-content-start gap-3 md:gap-[5%] border-b border-slate-300 px-5 py-7 flex-col md:flex-row items-center">
          ...
          <div className="flex flex-col justify-between items-start gap-3">
            ...
            <div className="flex text-base  text-start font-normal gap-3 items-start">
              <p className="text-base font-medium">
                Rs. {weiToPKR(agreementData.rentAmount)} <br />{" "}
          ...
          {islandlord &&
            ...
            !agreementData.landlordApprovalForCancellation && (
              <div className="">
                <button
                  onClick={() =>
                    handleApproveCancellation(agreementData.agreementId)
                  }
                  type="button"
                  className="text-red-500 border border-solid border-red-500 text-xl lg:text-2xl bg-red-50 hover:bg-red-500 hover:text-white p-3 rounded-xl"
                >
          ...
          <div className="flex flex-col gap-6 px-5 py-7  mr-2  md:w-1/3 relative">
            <div className="flex flex-col gap-2">
              ...
              <h1 className="text-lg ">
                <span className="font-semibold">Agreement Id :</span>{" "}
              ...
              <div className="flex flex-col gap-2">
                ...
                <h1 className="text-lg text-slate-400 font-medium"></h1>
              </div>
              <div className="flex flex-col gap-2">
                <h1 className="text-lg text-slate-900 font-medium">
      ...
      >
        <Link
          to={`/properties/${agreementData.propertyId}/${"1 Jan-2024"}`}
          className="flex w-full flex-col hover:bg-slate-200"
        >
          <h1 className="text-2xl font-semibold px-5 pt-7 mb-1">
            Property Details
          </h1>
            ...
            >
              <div className="flex flex-col md:flex-row gap-6 md:gap-0">
                ...
                <div className="lg:w-[60%] md:pl-6">
                  <div className="hidden md:flex text-xl font-semibold  hover:text-accent">
                    {agreementData.propertyDetails.propertyType}
                  </div>
                  ...
                  <p className="description   w-full md:w-[90%]">
                    ...
                    {agreementData.propertyDetails.description}
                  </p>
                </div>
              </div>
            </div>
      ...
      >
        <div className="flex w-full flex-col">
          ...
          <div className="py-5">
            {/* Landlord  */}
            <Link
              className="  hover:bg-slate-200 flex w-full justify-between  items-center py-5 relative border-t px-5 gap-5 border-slate-300"
              to={`/user/${agreementData.landlordWalletAddress}`}
            >
              <div className="flex flex-col md:flex-row gap-2 md:gap-0">
                <div className="flex items-center justify-start">
                  ...
                  />
                  <div>
                    <div className="flex md:hidden text-xl font-semibold  hover:text-accent">
                      {agreementData.landlord.name}
                    </div>
                  </div>
                </div>
                <div className="lg:w-[80%] md:pl-6">
                  <div className="hidden md:flex text-xl mb-1  font-semibold  hover:text-accent">
                    {agreementData.landlord.name}
                  </div>
                  ...
                  <div className="place-content-start items-center md:w-full text-slate-600  w-[280px] truncate">
            ...
            {/* tenant  */}
            <Link
              className="flex hover:bg-slate-200 w-full justify-between items-center py-5 relative border-t px-5 gap-5 border-slate-300"
              to={`/user/${agreementData.tenantWalletAddress}`}
            >
              <div className="flex flex-col md:flex-row gap-2 md:gap-0">
                <div className="flex items-center justify-start">
                  <img
            ...
            <Link
              className="flex hover:bg-slate-200 w-full justify-between items-center py-5 relative border-t px-5 gap-5 border-slate-300"
              to={`/user/${agreementData.stateAgentWalletAddress}`}
            >
              <div className="flex flex-col md:flex-row gap-2 md:gap-0">
                <div className="flex items-center justify-start">
                  <img
                ...
                <div className="lg:w-[80%] md:pl-6">
                  ...
                  <div className="place-content-start items-center w-full text-slate-600 ">
                    ...
                    {agreementData.stateAgent.estateName}
                  </div>
                </div>
              </div>
            </Link>
